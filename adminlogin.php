...
<body>
  ...
  if($_SERVER["REQUEST_METHOD"] == "POST")
  {
    ...
    {
      $sql="SELECT Password FROM adminlogin WHERE ID='$id'";
   ...
   ?>
    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
          ...
          <small style="color:#56baed"><i>Admin</i></small>
          <form method="post">
            ...
            <input type="submit" class="fadeIn fourth" value="Log In" name="admlogin">
          </form><br>
          <a href="forgotpw.php"><small>Forgot Password?</small></a>
        </div>
      </div>
      <footer id="footer">
        <div class="end">
